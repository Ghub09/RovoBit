...
return (
  ...
  .map((trade, idx) => (
              <tr
                key={trade._id || idx}
                className="hover:bg-gray-800  items-center transition-colors "
              >
                <td className="px-4   py-2 text-sm text-gray-200 flex items-center justify-self-center h-[100%]">
                  <img
    ...
    .map((trade, idx) => (
      ...
      >
        ...
        <div className="mt-2 space-y-1">
          ...
          <div className="flex justify-between">
            <span>Fee (1%)</span>
            <span> {(trade.assetsAmount*1)/100}</span>
